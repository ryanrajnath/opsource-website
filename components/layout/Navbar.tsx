...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-white/95 backdrop-blur-md border-t border-slate-200 px-4 py-3 flex gap-3">
        <a
          href="tel:8668708133"
          className="flex-[2] flex items-center justify-center gap-2 bg-orange-action text-white font-semibold py-3 rounded-lg text-base shadow-[0_2px_10px_rgba(234,88,12,0.25)]"
        >
        ...
        <Link
          href={EXTERNAL_URLS.jobPortal}
          target="_blank"
          className="flex-1 flex items-center justify-center gap-2 border-2 border-navy-deep text-navy-deep font-semibold py-3 rounded-lg text-sm"
        >
          <Search className="w-4 h-4" />
          {t("common.findAJob")}
        </Link>
